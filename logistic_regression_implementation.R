...
#Takes four inputs: 
#X: a design matrix including first column of 1's 
#y: a resposnse vector 
#threshold: the minimum size for the convergence threshold 
#max_iter: how many iterations of the algorithm we go through before declaring non-convergence 
